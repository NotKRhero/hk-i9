...
```
bash <(curl -s https://raw.githubusercontent.com/NotKRhero/hk-i9/main/install.sh)
  ```
```
bash <(wget -qO- https://raw.githubusercontent.com/NotKRhero/hk-i9/main/install.sh)
 ```
